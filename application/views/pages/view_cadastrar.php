...
<body class="text-center">
  <form class="form-signin" method="post" action="<?= base_url() ?>cadastrar/store">
    ...
    <input type="text" name="nome" id="inputName" class="form-control mb-2" placeholder="Nome" required autofocus>
    ...
    <input type="text" name="cidade" id="inputCity" class="form-control mb-2" placeholder="Cidade" required autofocus>
